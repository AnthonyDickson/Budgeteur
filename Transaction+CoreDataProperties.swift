...
extension Transaction {
    ...
    public convenience init(insertInto context: NSManagedObjectContext, amount: Double, label: String = "", date: Date = .now, endDate: Date? = nil, recurrencePeriod: RecurrencePeriod = .never, userCategory: UserCategory?) {
